...
class DreamBoothDataset(Dataset):
    ...
    def __init__(
        ...
        self.num_instance_images = dataset.num_rows
    ...
    def __getitem__(self, index):
        example = {}
        value = self.dataset._getitem(index)
        instance_image = value["images"][0]
        ...
        if self.encoder_hidden_states is not None:
            ...
            text_inputs = tokenize_prompt(
                self.tokenizer, value["text"][0], tokenizer_max_length=self.tokenizer_max_length
            )
            example["instance_prompt_ids"] = text_inputs.input_ids
            example["instance_attention_mask"] = text_inputs.attention_mask

        if value.__contains__("class_data"):
            class_image = value["class_data"]
            ...
            if self.instance_prompt_encoder_hidden_states is not None:
                ...
                class_text_inputs = tokenize_prompt(
                    self.tokenizer, value["class_prompt"], tokenizer_max_length=self.tokenizer_max_length
                )
